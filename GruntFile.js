	...
	(
		{
			...
			compileAndCopy: { //child of parent task.
				...
				files: {
					/*destination*/ /*'html_dev/css/style.css'*/ 'html_dev/GeometricColor/style.css' : 'html_dev/GeometricColor/scss/style.scss' //source. The task Sass/CompileAndCopy looks at the style.scss and compiles/outputs that to style.css
					}
				}
			},
		...
		*/
		watch: //parent task . When I call 'grunt watch' in CMD this is what happens:
		{
			css: //child task
			{
				files: 'html_dev/GeometricColor/scss/style.scss', //watch this file
